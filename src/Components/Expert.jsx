...
const Expert = () => {
  return (
    <div className=' max-w-[1240px] mx-auto md:grid grid-cols-2 my-3 rounded-md shadow-lg shadow-[#787779]'>
      {/* border border-[orange] */}
        <div className=' h-[100%] col-span-1 p-4 inline'>
        {/* border border-[blue] */}
            <img src={Vector1} alt="vector1" className='md:w-[100%]  w-[80%] mx-auto '/>
        </div>
        <div className=' h-[100%] col-span-1 p-4 flex flex-col justify-center '>
        {/* border border-[blue] */}
            ...
            <button className='my-3 flex rounded justify-center items-center p-3 w-[30%] bg-black text-white font-bold text-[15px]'>Get Started <IoNavigate className=" text-2xl mx-4  "/></button>
            {/* border border-[red] */}
        </div>
